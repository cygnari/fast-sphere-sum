...
void amr(run_config& run_information, vector<double>& new_dynamics_state, vector<double>& old_dynamics_state,
        ...
        vector<vector<int>>& new_dynamics_points_parents, vector<double>& new_dynamics_areas) {
    // perform amr
    ...
    remesh_points(run_information, new_dynamics_state, old_dynamics_state, old_dynamics_triangles, old_dynamics_triangles_is_leaf, run_information.dynamics_initial_points);
    // cout << "here 4 3" << endl;
    // cout << count_nans(new_dynamics_state) << endl;
...
void amr_wrapper(run_config& run_information, vector<double>& dynamics_state, vector<vector<vector<int>>>& dynamics_triangles,
        vector<vector<bool>>& dynamics_triangles_is_leaf, vector<vector<int>>& dynamics_points_parents, vector<double>& dynamics_areas) {
    // amr
    ...
    // cout << "here 3 1" << endl;
    amr(run_information, new_dynamics_state, dynamics_state, new_dynamics_triangles, dynamics_triangles, new_dynamics_triangles_is_leaf, dynamics_triangles_is_leaf, new_dynamics_points_parents, dynamics_areas);
    // cout << "here 3 2" << endl;
